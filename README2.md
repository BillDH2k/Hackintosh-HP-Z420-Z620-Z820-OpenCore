...
- **EFI with OC 0.7.1**:
	...
	- Other limitation: Catalina can update to Big Sur, but not to Monterey (limitation of OC 0.7.1). But once in Big Sur, you may update to Monterey using the newer EFI.
